...
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/crbm.png);" data-stellar-background-ratio="0.5">
...
<!-- 							<h1>成人教育资料填写</h1> -->
							<img src="images/z5.png" width="30%" height="20%">
		...
		<div class="container">
         &nbsp;	&nbsp;	&nbsp;	&nbsp;		
                 ...
                 <img src="images/ck.png" height="50%" width="45%">
...
<!-- 提交 -->					
<form action="data2" method="post" id="dt">
						...
						<div class="row form-group">
							...
							<div class="col-md-6">
							    ...
							    <option selected="selected">选择院校</option>	
							    <s:iterator value="ys">
				...
				<option value="1" selected="selected">选择专业</option>	
				</select>
				</div>		
<!-- 专业验证 -->						
				<center>
				...
				<font size="4" color="red">				
						...
						<div class="row form-group">
							...
							<select id="city"  name="city"  placeholder="选择市区" onchange="yz8()" style="width:250px;height:52px">
							    <option selected="selected">选择市区</option>	
							  	<s:iterator value="ls">
							...
							<option selected="selected">选择县城</option>	  				   
							</select>	
							</div>								
						</div>
