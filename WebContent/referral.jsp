...
<!-- 背景 -->
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(upload/${eguide.picture1});" data-stellar-background-ratio="0.5">
...
<!-- 后台取值					 -->
						                               <img class="img-responsive" src="upload/${eguide.picture2 }" alt="work">
					</div>
...
<!-- 后台取值 -->					
						                              <img class="img-responsive" src="upload/${eguide.picture3 }" alt="work">
					</div>
					<div class="col-md-4 animate-box">
						<div class="mt">
							<div>
								<h4><i class="icon-user"></i>国家承认学历 教育部网上可查</h4>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>招生简介</h2>
					<p>招生管理公共平台”是让各种学生成功就业的学习平台，<br/>
                                                                      学历终身可查， 保证学生的就业，月拿高薪不是梦！</p>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
