      ...
      function yz8() {
	   ...
	   $.ajax({  
	        ...
	        success: function(data){	        	
	        	...
	        	sContent.options.add(new Option("---请选择城市---",""));
...
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/kjbm.png);" data-stellar-background-ratio="0.5">
...
<!-- 							<h1>资料填写</h1> -->
  <div id="box">			
		...
		<a href="contact03t.jsp"><div class="right"></div></a>
							...
							<img src="images/z4.png" width="20%" height="20%">
						</div>
					</div>
				</div>
			</div>
			...
			<img  src="images/kj.png" width="100%" height="80%">
		...
		<div class="container">
         &nbsp;	&nbsp;	&nbsp;	&nbsp;		
                 ...
                 <img src="images/cj.png" height="75%" width="45%">
...
<!-- 提交 -->					
<form action="data" method="post" id="dt">
				...
				<div class="row form-group">
					<div class="col-md-12">
						...
						<input type="text" id="nrx" name="nrx" class="form-control" placeholder="学习内容" onblur="yz3()">
				</div>
<!-- 验证结果2 -->						
				<center>
				<font size="4" color="red">				
						...
						<div class="row form-group">
							...
							<option selected="selected">---请选择县城---</option>	  				   
							</select>	
							</div>								
						</div>
