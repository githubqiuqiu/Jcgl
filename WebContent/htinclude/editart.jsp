...
<body class="easyui-layout">
	<div data-options="region:'center',split:true" style="height:200px">
		<form  action="artedit" method="post" id="su">
		<input type="hidden" name="abean.aid" value="${abean.aid }"/>
		<input type="hidden" name="abean.id" value="${abean.id }"/>
			姓名：<input type="text" class="easyui-textbox" name="abean.aname" value="${abean.aname}" id="sm"/>&nbsp;&nbsp;&nbsp;&nbsp;学号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="easyui-textbox" name="abean.astudentno" value="${abean.astudentno}" readonly="readonly" id="xh"/><br/>
			...
			<br/>所属城市：<select id="sel1" class="easyui-combobox" name="abean.cid" style="width:80px">
				<s:iterator value="citylist">
					<option value="${cid }" ${cid==abean.cid?'selected':'' }>${cname }</option>
				</s:iterator>
			</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所属地区：<select id="sel2" class="easyui-combobox" name="abean.coid" style="width:80px">
