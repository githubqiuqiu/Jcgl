...
<body class="easyui-layout">
	<div data-options="region:'center',split:true" style="height: 120px">
		<form action="addrelation" method="post" id="frm">
			QQ：&nbsp;<input class="easyui-textbox" name="relation.rqq" id="qq"><br/>
			电话：<input class="easyui-textbox" name="relation.rphone" id="dh"><br/>
			名称：<input class="easyui-textbox" name="relation.rcontent" id="mc"><br/>
			负责类型：    <select name="relation.reffect" class="easyui-combobox">
						<option value="成考" selected>成考</option>
