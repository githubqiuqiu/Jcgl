...
<body class="easyui-layout">
	<div data-options="region:'center',split:true" style="height: 120px">
		<form action="addnotice" method="post" id="frm">
			标题：<input class="easyui-textbox" name="notice.ntitle" id="bt"><br/>
			内容：<input class="easyui-textbox" name="notice.ncontent" id="nr"><br/>
			日期：<input class="easyui-datebox" name="notice.ndate" id="rq"><br/>
		</form>
	</div>
