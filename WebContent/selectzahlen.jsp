				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<table width="100%" bgcolor="white">
							...
							<tr height="10%">
								<td colspan="10"><img src="images/jfcx.png" width="55%">
								</td>
							</tr>
							...
							<tr bgcolor="#333333">
								...
								<td><font color="white"> 需缴金额 </font></td>
								<td><font color="white"> 实缴金额 </font></td>
								<td><font color="white"> 缴费时间 </font></td>
								<td><font color="white"> 班主任 </font></td>
								<td><font color="white"> 缴费状态 </font></td>
							</tr>

							<!-- ----------------------------数据内容------------------------------------------ -->
							<s:iterator value="list">
							<tr>
								<td><font color="white"> <!-- 								姓名 -->
									<s:property value="sname"/>
								</font></td>
								<td><font color="white"> <!-- 								需缴金额 -->
									<s:property value="needmoney"/>
								</font></td>
								<td><font color="white"> <!-- 								实缴金额 -->
									<s:property value="practicalmoney"/>
								</font></td>
								<td><font color="white"> <!-- 								缴费时间 -->
									<s:property value="fdata"/>
								</font></td>
								<td><font color="white"> <!-- 								班主任 -->
									<s:property value="ftest2"/>
								</font></td>
								<td><font color="white"> <!-- 								缴费状态 -->
									<s:if test="fstatu==0">
										未缴费
									</s:if>
									<s:if test="fstatu==1">
