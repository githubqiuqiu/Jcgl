...
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/yk1.png);" data-stellar-background-ratio="0.5">
...
<!-- 							<h1>资料填写</h1> -->
  <div id="box">			
		...
		<a href="contact03t.jsp"><div class="right"></div></a>
							...
							<img src="images/z2.png" width="20%" height="20%">
						</div>
					</div>
				</div>
			</div>
			...
			<img  src="images/yk.png" width="100%"  height="80%">
		...
		<div class="container">
         &nbsp;	&nbsp;	&nbsp;	&nbsp;		
                 ...
                 <img src="images/ykc.png" height="80%" width="45%">
...
<!-- 提交 -->					
<form action="data3" method="post" id="dt">
