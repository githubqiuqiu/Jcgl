...
function add(){
	...
	$('#tab').datagrid({
		...
		url:"selstatefinance?astudentno="+astudentno+"&aname="+aname+"&teacher="+teacher+"&status="+status+"&types="+types,
...
function edits(id){
		//alert("进了编辑");
	  $('#winedit').window('open');
	  $('#winedit').window('refresh','beforestatefinanceedit.action?id='+id);
}
