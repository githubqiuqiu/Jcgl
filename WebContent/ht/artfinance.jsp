...
function add(){
	...
	$('#tab').datagrid({
		...
		url:"selartfinance?astudentno="+astudentno+"&aname="+aname+"&teacher="+teacher+"&status="+status+"&types="+types,
...
function edits(id){
		//alert("进了编辑");
	  $('#winedit').window('open');
	  $('#winedit').window('refresh','beforeartedit.action?id='+id);
}
...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="height:50px">
		<table id="tab" fit="true" class="easyui-datagrid" style="padding:0px" title="艺考缴费信息表"></table>
	</div>
