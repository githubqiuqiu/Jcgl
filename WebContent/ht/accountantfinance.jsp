...
function add(){
	...
	$('#tab').datagrid({
		...
		url:"selaccfinance?astudentno="+astudentno+"&aname="+aname+"&teacher="+teacher+"&status="+status+"&types="+types,
...
function edits(id){
		//alert("进了编辑");
	  $('#winedit').window('open');
	  $('#winedit').window('refresh','beforeaccedit.action?id='+id);
}
...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="height:50px">
		<table id="tab" fit="true" class="easyui-datagrid" style="padding:0px" title="会计缴费信息表"></table>
	</div>
	...
	<div id="winadd" class="easyui-window" 
		...
		title="编辑" 
		data-options="modal:true,closed:true,collapsible:false,minimizable:false,maximizable:false,border:false" 
		style="width:500px;height:230px;padding:5px;">
		</div> 
