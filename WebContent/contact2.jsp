...
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/gjbm.png);" data-stellar-background-ratio="0.5">
...
<!-- 							<h1>资料填写</h1> -->
  <div id="box">			
	 ...
	 &nbsp;
			<center>
			<img  src="images/kfbm.png" width="100%" height="80%">
			<img  src="images/kfd.png" width="70%" height="10%">
        </center>
        <div class="container">
        &nbsp;
        </div>
		...
		<div class="container">
         &nbsp;	&nbsp;	&nbsp;	&nbsp;		
                 ...
                 <img src="images/kfdx.png" height="50%" width="45%">
...
<!-- 提交 -->					
<form action="data5" method="post" id="dt">
