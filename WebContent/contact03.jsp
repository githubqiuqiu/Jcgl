...
<!-- 							<h1>资料填写</h1> -->
  <div id="box">			
		...
		<center>
			<img  src="images/zg3.png" width="80%"  height="80%">
        </center>
		...
		<div class="container">
         &nbsp;	&nbsp;	&nbsp;	&nbsp;		
                 ...
                 <img src="images/zgzs.png" height="100%" width="45%">
...
<!-- 提交 -->					
<form action="data4" method="post" id="dt">
...
<!-- 短信验证结果 -->						
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="contact03t.jsp" class="btn btn-default btn-lg">返回课程选择</a></p>
				</div>
			</div>
		</div>
	</div>
