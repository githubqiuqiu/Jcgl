...
public class Artfinance implements Serializable{
	...
	//与报名表一对一
	private Artapply artapply;
	public Artapply getArtapply() {
		return artapply;
	}
	public void setArtapply(Artapply artapply) {
		this.artapply = artapply;
	}
}
