...
public class Professionfinance implements Serializable{
	...
	//与报名表一对一
	private Professionapply professionapply;
	public Professionapply getProfessionapply() {
		return professionapply;
	}
	public void setProfessionapply(Professionapply professionapply) {
		this.professionapply = professionapply;
	}
}
